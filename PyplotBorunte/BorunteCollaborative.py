...
class BRTIRXZ0805A(DHRobot):
    ...
    def __init__(self):
        ...
        self.qr = np.array([0, -90, 0, 0, 0, 0]) * deg # Blueprint position
        self.qz = np.array([0, -90, 90, -90, -90, 0]) * deg # Zero Position
        self.qs = np.array([0, -90, 90, -90, -90, 0]) * deg # Scheme Zero Position
